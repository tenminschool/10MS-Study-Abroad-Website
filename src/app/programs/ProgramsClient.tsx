...
import type { Program } from '../../data/destinations';
import './programs.css';
...
export default function ProgramsClient({ enrichedPrograms }: { enrichedPrograms: EnrichedProgram[] }) {
  ...
  const categories = [
    ...
    { id: 'Computer Science', label: 'কম্পিউটার সায়েন্স', enLabel: 'Computer Science' },
    { id: 'Business', label: 'বিজনেস', enLabel: 'Business' },
    { id: 'Engineering', label: 'ইঞ্জিনিয়ারিং', enLabel: 'Engineering' },
  ...
  const t = {
    bn: {
      ...
      subtitle: "বিশ্বসেরা সব বিশ্ববিদ্যালয় থেকে তোমার স্বপ্নের কোর্স ও ডিগ্রি বেছে নাও",
      allFunding: "ডিগ্রি ও কোর্সের বিস্তারিত তথ্য",
      searchPlaceholder: "প্রোগ্রাম বা বিশ্ববিদ্যালয়ের নাম দিয়ে খোঁজো...",
      filterTitle: "ফিল্টারসমূহ",
      clearAll: "সব মুছুন",
      countryFilter: "🌍 দেশ / গন্তব্য",
      degreeFilter: "🎓 ডিগ্রির স্তর",
      subjectFilter: "📚 বিষয় ক্ষেত্র",
      resultsCount: (count: number) => `মোট ${count} টি প্রোগ্রাম পাওয়া গেছে`,
      emptyTitle: "কোনো প্রোগ্রাম পাওয়া যায়নি",
      emptyDesc: "আপনার সিলেক্ট করা ফিল্টারের সাথে মিলে যায় এমন কোনো প্রোগ্রাম আপাতত নেই। শীঘ্রই যুক্ত করা হবে।",
